      ...
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        >
          ...
          <p className="leading-relaxed mb-5">
            ...
            skills every day. I am not afraid of a challange & I also work well
            with teams to get the work done. Im trainable, coachable, and open
            to learning new practices & concepts.
          </p>
