    ...
    <div>
      ...
      >
        ...
        <p className="leading-relaxed mb-5">
          ...
          really enjoy web development as well as learning & improving my skills
          every day. I am not afraid of a challange & I also work well with
          teams to get the work done. Im trainable, coachable, and open to
          learning new practices & concepts.
        </p>
        ...
        <div className="relative mb-4">
          ...
          <textarea
            id="message"
            name="message"
            className="w-full bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-4 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
